    ...
    <div className="min-h-screen bg-white pt-24 pb-16 px-4">
      <div className="max-w-6xl mx-auto">
        <FadeIn>
          <div className="mb-10">
            <h1 className="font-display text-3xl sm:text-4xl text-navy mb-2">
              Your family&apos;s college dashboard
            </h1>
            <p className="font-body text-navy/60">
              Working together on this. Every step counts.
            </p>
          </div>
        </FadeIn>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {savedColleges.map((c) => (
                    <li key={c.id} className="p-3 rounded-md bg-cream/50">
                      <div className="flex items-center justify-between">
                        ...
                        <button className="font-mono-label text-xs text-gold hover:text-gold/80 transition-colors">
                          Add notes
                        </button>
                      </div>
                      {c.user_notes && (
          ...
          <FadeIn delay={0.1}>
            <div className="ktc-card p-6 h-full">
              ...
              <p className="font-body text-xs text-navy/40 mb-4">
                This is their essay. We just help them make it great.
              </p>
              {sectionsLoading ? (
                <LoadingSpinner size="sm" />
              ) : essays.length === 0 ? (
                <p className="font-body text-sm text-navy/50">
                  No essay drafts yet. Your student can start in the{" "}
                  <Link
          ...
          {/* Checklist — parent + student items */}
          <FadeIn delay={0.15}>
            <div className="ktc-card p-6 h-full">
              <h2 className="font-display text-xl text-navy mb-1">
                Checklist
              ...
              {sectionsLoading ? (
                ...
                <p className="font-body text-sm text-navy/50">
                  Nothing due soon. Your family is on track!
                </p>
              ) : (
                <ul className="space-y-3">
                  {checklist.map((item) => (
                    ...
                    >
                      ...
                      <button className="font-mono-label text-xs text-gold hover:text-gold/80 transition-colors flex-shrink-0">
                        Share
                      </button>
                    </li>
                  ))}
                    ...
                    <li key={s.id}>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            className="font-mono-label text-xs text-gold hover:text-gold/80 transition-colors"
            ...
            <div className="ktc-card p-6 h-full">
              ...
              <dl className="space-y-3 mb-6">
                ...
                <div>
                  ...
                  <dd className="font-body text-sm text-navy">Parent</dd>
                </div>
                <div>
                  <dt className="font-body text-xs text-navy/40 uppercase tracking-wider">
                    Account ID
