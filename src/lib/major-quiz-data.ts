...
const MAJOR_DB: (MajorResult & { signals: string[] })[] = [
  ...
  { name: "Business / Entrepreneurship", slug: "business", description: "Learn how organisations work, from marketing to finance to management. Versatile and in demand.", signals: ["Leading teams", "Working with numbers", "With lots of people", "Build products/companies", "Generate wealth"] },
